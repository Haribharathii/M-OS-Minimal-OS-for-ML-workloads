...
(C.1) faber_fs_thread_test (6 out of 6 pts)
    What is your kshell command to invoke faber_fs_thread_test(): thrtest n, where n =1,2,3,...
(C.2) faber_directory_test (4 out of 4 pts)
    What is your kshell command to invoke faber_directory_test(): dirtest n, where n =1,2,3,...
...
Cannot halt kernel cleanly : (-5 pts)
