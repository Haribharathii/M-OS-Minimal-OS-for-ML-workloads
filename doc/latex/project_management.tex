...
Requests for a copy of Weenix may be made via email to \texttt{}.
...
% For hardware virtualization, Weenix can use QEMU, Bochs, or VirtualBox.  We recommend QEMU, for its relative ease of setup and (we've found) superior simulation speed and quality.  You may need a special build of Bochs in order to use it with Weenix; feel free to contact \texttt{} if Weenix doesn't seem compatible with your installation of Bochs.
