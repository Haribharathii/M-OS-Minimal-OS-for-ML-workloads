...
(E) Additional self-checks: (10 out of 10 pts)
    ...
    Details: none is needed, every function is called in either kernel boot or faber, sunghan tests
...
+--------------------------------------------------------------------------------------------+
These are the exact times you could look for the gdb_conforming calls for each implemented function!

bootstrap() : (GRADING1A 1.a) : Kernel boot
idleproc_run() : (GRADING1E) : Kernel boot
initproc_create() : (GRADING1A 1.b) : Kernel boot
initproc_run() :  (GRADING1E) : Kernel boot
kmutex_init() : (GRADING1E) : Kernel boot
kmutex_lock() : (GRADING1A 6.a) : Kernel boot (Kshell creation)
kmutex_lock_cancellable() : (GRADING1C 7) : Faber test
kmutex_unlock() : (GRADING1C 7) : Faber test
proc_create() : (GRADING1A 2.a) : Kernel boot
proc_cleanup() : (GRADING1A 2.b) : Faber test
proc_kill() : (GRADING1C 8) : Faber test
proc_kill_all() : (GRADING1C 9) : Faber test
proc_thread_exited() : (GRADING1C 1) : Faber test
do_waitpid() : (GRADING1C 1) : Kernel boot (Kshell creation)
do_exit() : (GRADING1C 1) : Faber test
kthread_create() : (GRADING1A 3.a) : Kernel boot
kthread_cancel() : (GRADING1A 3.b) : Faber test
kthread_exit() : (GRADING1A 3.c) : Faber test
sched_sleep_on() : (GRADING1C 4) : Kernel boot (Kshell creation)
sched_wakeup_on() : (GRADING1C 4) : Faber test
sched_broadcast_on() : (GRADING1C 3) : Kernel boot (Kshell creation)
sched_cancellable_sleep_on() : (GRADING1C 3) : Kernel boot (Kshell creation)
sched_cancel() : (GRADING1C 5) : Faber test
sched_switch() : (GRADING1C 7) : Kernel boot (Kshell creation)
sched_make_runnable() : (GRADING1C 5.a) : Kernel boot

+-----------------------------------------------+
| OTHER (Optional) - Not considered for grading |
+-----------------------------------------------+

Comments on design decisions: Implemented the Not-implemented primitives!
